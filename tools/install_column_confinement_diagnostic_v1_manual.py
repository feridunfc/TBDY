...
(root / "tools" / "inspect_column_confinement_v1.py").write_text(r'''
...
(root / "tests" / "test_column_confinement_diagnostic_v1.py").write_text(r'''
...
print("INSTALLED")
print(root / "tools" / "inspect_column_confinement_v1.py")
print(root / "tests" / "test_column_confinement_diagnostic_v1.py")
