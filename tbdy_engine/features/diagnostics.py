...
class FeatureDiagnosticCode(StrEnum):
    ...
    STORY_BASE_SOURCE_INCOMPLETE = "STORY_BASE_SOURCE_INCOMPLETE"
    STORY_BASE_REQUIRED_COLUMN_MISSING = "STORY_BASE_REQUIRED_COLUMN_MISSING"
    STORY_BASE_VALUE_INVALID = "STORY_BASE_VALUE_INVALID"
    STORY_BASE_OUTPUT_CASE_UNAVAILABLE = "STORY_BASE_OUTPUT_CASE_UNAVAILABLE"
    STORY_BASE_SELECTOR_NO_MATCH = "STORY_BASE_SELECTOR_NO_MATCH"
    ...
    MATERIAL_SOURCE_INCOMPLETE = "MATERIAL_SOURCE_INCOMPLETE"
    MATERIAL_REQUIRED_COLUMN_MISSING = "MATERIAL_REQUIRED_COLUMN_MISSING"
    MATERIAL_VALUE_INVALID = "MATERIAL_VALUE_INVALID"
    MATERIAL_SECTION_CONTEXT_MISSING = "MATERIAL_SECTION_CONTEXT_MISSING"
    MATERIAL_COMPONENT_CONTEXT_MISSING = "MATERIAL_COMPONENT_CONTEXT_MISSING"
