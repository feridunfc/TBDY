...
class FeatureDiagnosticCode(StrEnum):
    ...
    MODAL_REQUIRED_COLUMN_MISSING = "MODAL_REQUIRED_COLUMN_MISSING"
    MODAL_SOURCE_INCOMPLETE = "MODAL_SOURCE_INCOMPLETE"
    MODAL_ROW_COUNT_MISMATCH = "MODAL_ROW_COUNT_MISMATCH"
    MODAL_MULTIPLE_CASES_UNSUPPORTED = "MODAL_MULTIPLE_CASES_UNSUPPORTED"
    MODAL_CASE_VALUE_INCOMPLETE = "MODAL_CASE_VALUE_INCOMPLETE"
