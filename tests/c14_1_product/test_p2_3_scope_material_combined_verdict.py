...
def test_product_slice_manifest_uses_explicit_p2_3_semantics(tmp_path: Path):
    ...
    assert manifest["report_package_sprint_id"] == "P2_7_P2_9_MATERIAL_DRIFT_TORSION_CHECKRESULTS"
    assert manifest["truth_model_version"] == "P2_7_P2_9_CHECK_RESULT_TRUTH_MODEL_V1"
