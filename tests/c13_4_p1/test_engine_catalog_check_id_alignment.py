...
from tbdy_engine.checks.wall_contract import PACK_B_NEW_CHECK_IDS
...
def _catalog_ids() -> set[str]:
    ...
    for catalog_path in (BASE_CHECK_CATALOG, C13_5_CHECK_OVERLAY, P2_10_WALL_PACK_A_OVERLAY, P2_10_WALL_PACK_B_OVERLAY):
...
def test_allowed_checks_exist_in_check_catalog():
    ...
    } | set(PACK_A_CHECK_IDS) | set(PACK_B_NEW_CHECK_IDS)
